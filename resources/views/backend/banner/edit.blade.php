...
@section('title','Glow Ethio Türkiye || Banner Edit')
...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <div class="form-group">
          <label for="inputDesc" class="col-form-label">Header</label>
          <textarea class="form-control" id="header" name="header">{{$banner->header}}</textarea>
          @error('header')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
              ...
              <input id="video" class="form-control" type="text" name="photo2" value="{{old('photo2')}}">
          </div>
