...
@section('title','Glow Ethio Türkiye || DASHBOARD')
        ...
        <div class="card border-left-primary shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Service Category</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">
                @php 
                     $category=DB::table('categories')->select('id')->Count('id');
                 @endphp
                 {{$category}}
                </div>
              </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">
                  @php 
                       $services=DB::table('service')->select('id')->Count('id');
                   @endphp
                   {{$services}}
                  </div>
                </div>
           ...
           <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Blog categories</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                    @php 
                         $blogcategories=DB::table('blogcategories')->select('id')->Count('id');
                     @endphp
                     {{$blogcategories}}
                    </div>
                  </div>
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">
                @php 
                     $blogs=DB::table('blogs')->select('id')->Count('id');
                 @endphp
                 {{$blogs}}
                </div>
              </div>
           ...
           <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Utilities</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                    @php 
                         $utilities=DB::table('utilities')->select('id')->Count('id');
                     @endphp
                     {{$utilities}}
                    </div>
                  </div>
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">
                @php 
                     $packages=DB::table('packages')->select('id')->Count('id');
                 @endphp
                 {{$packages}}
                </div>
              </div>
        ...
        <div class="col mr-2">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col-auto">
              ...
              @php 
                $messages=DB::table('messages')->select('id')->Count('id');
              @endphp
             {{$users}}
              </div>
            </div>
