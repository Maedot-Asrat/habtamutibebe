...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Services Lists</h6>
      <a href="{{route('service.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add New Service</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
            ...
            @foreach($services as $service)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($service->photo)
                            <img src="{{$service->photo}}" class="img-fluid" style="max-width:80px" alt="{{$service->photo}}">
                        @else
                    ...
                    <td>
                        <a href="{{route('service.edit',$service->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-eye"></i></a>
        ...
        @else
          <h6 class="text-center">No Servicee found!!! Please create Category</h6>
        @endif
      </div>
    </div>
</div>
