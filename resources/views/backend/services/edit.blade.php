...
<div class="card">
    <h5 class="card-header">Edit Selected Service</h5>
    <div class="card-body">
      <form method="post" action="{{route('service.update',$services->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="class" class="form-control">
            <option value="eng" {{(($services->class=='eng') ? 'selected' : '')}}>English</option>
            <option value="amh" {{(($services->class=='amh') ? 'selected' : '')}}>Amharic</option>
          </select>
          @error('class')
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Enter title"  value="{{$services->title}}" class="form-control">
          @error('title')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="" name="summary">{{$services->summary}}</textarea>
          @error('summary')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
