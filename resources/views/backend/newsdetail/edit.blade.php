...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('newsdetail.update',$newsdetails->id)}}">
        @csrf 
        @method('PATCH')
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="sub_heading" placeholder="{{$newsdetails->sub_heading}}"  value="{{$newsdetails->sub_heading}}" class="form-control">
          @error('sub_heading')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="detail" name="detail">{{$newsdetails->detail}}</textarea>
          @error('detail')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group" id='parent_cat_div'>
          <label for="blogcat_id">News Category</label>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="video_link" name="video_link">{{$newsdetails->video_link}}</textarea>
          @error('video_link')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="headerholder" class="form-control" type="text" name="photo1" value="{{$newsdetails->photo1}}">
        </div>
        ...
        <div class="form-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="headerphoto" value="{{$newsdetails->headerphoto}}">
        </div>
        <div class="form-group">
